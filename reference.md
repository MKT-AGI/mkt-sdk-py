...
<details><summary><code>client.wisdom.<a href="src/MKT_AGI/wisdom/client.py">list_purchased_communities</a>() -> GithubComMktAgiAixInternalPkgGinxResultArrayInternalWisdomInternalWebPurchaseItemResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.wisdom_community.<a href="src/MKT_AGI/wisdom_community/client.py">set_community_pricing</a>(...) -> GithubComMktAgiAixInternalPkgGinxResultInternalWisdomInternalWebCommunityResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.wisdom_community.<a href="src/MKT_AGI/wisdom_community/client.py">purchase_community</a>(...) -> GithubComMktAgiAixInternalPkgGinxResultMapStringString</code></summary>
<dl>
<dd>
...
## WisdomMarketplace
<details><summary><code>client.wisdom_marketplace.<a href="src/MKT_AGI/wisdom_marketplace/client.py">list_marketplace_communities</a>(...) -> GithubComMktAgiAixInternalPkgGinxResultInternalWisdomInternalWebMarketplaceListResponse</code></summary>
<dl>
<dd>
...
**search:** `typing.Optional[str]` — Search by label
...
**min_price:** `typing.Optional[float]` — Minimum price filter
...
**max_price:** `typing.Optional[float]` — Maximum price filter
...
**sort:** `typing.Optional[str]` — Sort field: created_at, price, member_count
...
**order:** `typing.Optional[str]` — Sort order: asc, desc
