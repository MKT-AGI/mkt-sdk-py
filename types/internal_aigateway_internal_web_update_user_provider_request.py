...
class InternalAigatewayInternalWebUpdateUserProviderRequest(UniversalBaseModel):
    ...
    protocol: typing.Optional[InternalAigatewayInternalWebUpdateUserProviderRequestProtocol] = pydantic.Field(
        default=None
    )
    """
